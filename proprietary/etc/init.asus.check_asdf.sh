...
# ASUS_BSP Deeo : Set eMMC status in property +++
storage_status=`cat /sys/bus/mmc/devices/mmc0\:0001/emmc_status`
storage_health=`cat /sys/bus/mmc/devices/mmc0\:0001/emmc_health`
setprop asus.storage.primary.status $storage_health
setprop asus.storage.primary.type eMMC
storage_size=`cat /sys/bus/mmc/devices/mmc0\:0001/emmc_total_size`
setprop asus.storage.primary.size "$storage_size"G
storage_preEOL=`cat /sys/bus/mmc/devices/mmc0\:0001/emmc_preEOL`
setprop asus.storage.primary.health $storage_preEOL
stroage_healthA=`cat /sys/bus/mmc/devices/mmc0\:0001/emmc_health_A`
setprop asus.storage.primary.healthtypeA $stroage_healthA
stroage_healthB=`cat /sys/bus/mmc/devices/mmc0\:0001/emmc_health_B`
